...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QSize(300, 490))
        MainWindow.setMaximumSize(QSize(300, 490))
...
"}")
        ...
        self.verticalLayoutWidget.setGeometry(QRect(10, 10, 281, 471))
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout.addWidget(self.bplus_minus, 4, 0, 1, 1)

        self.bcomma = QPushButton(self.verticalLayoutWidget)
        self.bcomma.setObjectName(u"bcomma")

        self.gridLayout.addWidget(self.bcomma, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.bequal, 4, 3, 1, 1)
